...
public class EnemySpawner : SingletonMonoBehaviour<EnemySpawner>
{
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangeEventArgs roomChangeEventArgs)
    {
        ...
        // If the room is a corridor of the entrance then return
    ...
    private void SpawnEnemies()
    {
        ...
        if (GameManager.Instance.gameState == GameState.playingLevel)
        {
            ...
            GameManager.Instance.gameState = GameState.engagingEvemies;
        }
    ...
    private void Enemy_OnDestroyed(DestroyedEvent destroyedEvent, DestroyedEventArgs destroyedEventArgs)
    {
        ...
        if (currentEnemyCount <= 0 && enemiesSpawnedSoFar == enemiesToSpawn)
        {
            ...
            // Set game state
            if (GameManager.Instance.gameState == GameState.engagingEvemies)
            {
                GameManager.Instance.gameState = GameState.playingLevel;
                GameManager.Instance.previousGameState = GameState.engagingEvemies;
            }
