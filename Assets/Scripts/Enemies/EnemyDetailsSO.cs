...
public class EnemyDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Distance to yhe player before enemy starts chasing")]
    #endregion
    ...
    [Tooltip(
        "The maximum time delay interval in seconds between bursts of enemy shooting. This value should be greater than 0. A random value will be selected between the minimum value and the maximum value")]
    ...
    [Tooltip("The maximum firing duration that the enemy shoots for during a firing burst. This value should be greater than zero. A random value will be selected between the minimum value and the maximum value.")]
    ...
    [Tooltip("Select this if line of sight is required of the player before the enemy fires. If line of sight isn't selected the enemy will fire regardless of obstacles whenever the player in 'in range'")]
    ...
    #endregion
    public EnemyHealthDetails[] enemyHealthDetailArray;
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckEnumerableValues(this, nameof(enemyHealthDetailArray), enemyHealthDetailArray);
