...
public class ActiveWeapon : MonoBehaviour
{
    ...
    #region Tooltip
    [Tooltip("Populate with the Transfrom on the WeaponEffectPosition gameobject")]
    #endregion
    ...
    private void SetWeapon(Weapon weapon)
    {
        ...
        // Set current wepon sprite
        weaponSpriteRenderer.sprite = currentWeapon.weaponDetails.weaponSprite;

        // If the weapon has a polygon collider and a sprite then set it to the weapon sprite physicx shape
