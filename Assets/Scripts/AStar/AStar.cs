...
{
    /// <summary>
    /// Builds a path for the room, from the startGridPosition to the endGridPosition, end adds
    /// movement steps to the returned Stack. null if no path is found.
    /// </summary>
    ...
    /// <summary>
    /// Fin the shortest path - returns the end Node is a path has been found, else returns null.
    /// </summary>
        ...
        InstantiatedRoom instantiatedRoom)
    {
        ...
        while (openNodeList.Count > 0)
        {
            ...
            // Evaluate fcost for each naighbour of the current node
    ...
    /// <summary>
    /// Evaluate a neighbour node at neighbourNodeXPosition, neighbourYPosition, using the
