...
public class AStarTest : MonoBehaviour
{
    ...
    {
        pathStack = null;
        instantiatedRoom = roomChangeEventArgs.room.instantiatedRoom;
    ...
    /// <summary>
    /// Set the end position and the start tile on the front tilemap
    /// </summary>
    ...
    /// <summary>
    /// Build and display the AStar path between the start and finish position
    /// </summary>
