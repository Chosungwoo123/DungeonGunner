...
public class RoomTemplateSO : ScriptableObject
{
    ...
    [Tooltip("If you imagine a rectangle the room tilemap that just completely enclose it, the room upper bounds represent the top right corner of that rectangle. This should be determined from the tilemap for the room (using the coordinate brush pointer to get the tilemap grid position for that top right corner (Note: this is the local tilemap position and NOT world position")]
    ...
    [Tooltip("There should be a maximum of four doorways for a room - one for each compass derection. These should have a consistent 3 tile opening size, with the middle tile position being the doorway coordinate 'position'")]
    ...
    /// <summary>
    /// Returns the list of Entrances for the toom template
    /// </summary>
