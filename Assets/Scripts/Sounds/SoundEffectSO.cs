...
public class SoundEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The minimum pitch variation for the sound effect. A random pitch variation will be ganerated between the minimum and maximum values. A random pitch variation makes sound effects sound " +
        "more natural.")]
    #endregion
    [Range(0.1f, 1.5f)]
    ...
    #region Tooltip
    [Tooltip("The maximum pitch variation for the sound effect. A random pitch variation will be ganerated between the minimum and maximum values. A random pitch variation makes sound effects sound " +
        "more natural.")]
    #endregion
    [Range(0.1f, 1.5f)]
