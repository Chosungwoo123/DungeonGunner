...
{
    #region Tooltip
    [Tooltip("Populate this array with prefabs that you want to add to the pool, and specify the number of gameobject to be created for each.")]
    #endregion
    ...
    /// <summary>
    /// Reuse a gameobject component in the pool. 'prefab' is the prefab gameobject contain the component. 'position' is the world position for the gameobject 
    /// where it should appear when evabled. 'rotation' should be set if the gameobejct needs to be rotated.
    /// </summary>
