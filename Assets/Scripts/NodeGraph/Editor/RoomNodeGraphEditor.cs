...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    public static bool OnDoubbleClickAsset(int instanceID, int line)
    {
    ...
    {
        int vericalLineCount = Mathf.CeilToInt((position.width + gridSize) / gridSize);
        ...
        for(int i = 0; i < vericalLineCount; i++)
        {
    ...
    private void DrawDraggedLine()
    {
        if (currentRoomNodeGraph.linePosition != Vector2.zero)
        {
            ...
            Handles.DrawBezier(currentRoomNodeGraph.roomNodeToDrawLineFrom.rect.center, currentRoomNodeGraph.linePosition,
                currentRoomNodeGraph.roomNodeToDrawLineFrom.rect.center, currentRoomNodeGraph.linePosition, Color.white, null, connectingLineWidth);        // 베지에 곡선 그리기
        }
    }
    ...
    {
        // if releasing the right mouse buttom and currently dragging a line
    ...
    /// <summary>
    /// Cleat line drag from a room node
    /// </summary>
    ...
    private void DrawConnectionLine(RoomNodeSO parentRoomNode, RoomNodeSO childRoomNode)
    {
        ...
        Vector2 midPosition = (endPosition + startPosition) / 2f;   // 중앙 화살표를 위한 변수

        // Vector from start to end position of line
        Vector2 direction = endPosition - startPosition;        // 화살표 방향

        // Calulate normalised perpendicular positions from the mid point       수직 위치 계산
        Vector2 arrowTailPoint1 = midPosition - new Vector2(-direction.y, direction.x).normalized * connectingLineArrowSize;
        Vector2 arrowTailPoint2 = midPosition + new Vector2(-direction.y, direction.x).normalized * connectingLineArrowSize;

        // Calulate mid point offset position for arrow head                    헤드 위치 계산
    ...
    /// <summary>
    /// Draw room nodes in graph window
    /// </summary>
