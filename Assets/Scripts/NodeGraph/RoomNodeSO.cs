...
public class RoomNodeSO : ScriptableObject
{
    ...
    public void Draw(GUIStyle nodeStyle)
    {
        ...
        // if the roomnnode has a parent or is of type entrance then display a label else display a popup
    ...
    public bool IsChildRoomValid(string childID)
    {
        ...
        // If this child is already in the parentID list return false
    ...
    {
        // if the node catains the parent ID then remove it
